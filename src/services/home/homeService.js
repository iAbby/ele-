...
export function getLocation(lat,lon){
	return new Promise((resolve,reject)=>{
		axios.get(`/bgs${URL_API.locationUrl}?latitude=${lat}&longitude=${lon}`)
		.then((response)=>{
...
export function getWord(lat,lon){
	return new Promise((resolve,reject)=>{
		axios.get(`/shopping${URL_API.hotWordUrl}?latitude=${lat}&longitude=${lon}`)
		.then((response)=>{
...
export function getLocationList(keyword,lat,lon) {
	return new Promise((resolve,reject)=>{
		axios.get(`/bgs${URL_API.locationListUrl}?keyword=${keyword}&offset=0&limit=20&latitude=${lat}&longitude=${lon}`)
		.then((response)=>{
...
export function getSwiperList(lat,lon) {
	return new Promise((resolve,reject)=>{
		axios.get(`/shopping${URL_API.swiperUrl}?latitude=${lat}&longitude=${lon}&templates[]=main_template`)
		.then((response)=>{
...
export function getSellerList(lat,lon,offset,limit) {
	return new Promise((resolve,reject)=>{
		axios.get(`/shopping${URL_API.sellerListUrl}?latitude=${lat}&longitude=${lon}&&offset=${offset}&limit=${limit}&extras[]=activities&extras[]=tags&extra_filters=home&terminal=h5`)
		.then((response)=>{
...
export function getSellerTop(lat,lon,id){
	return new Promise((resolve,reject)=>{
		axios.get(`/shopping${URL_API.sellertopUrl}${id}?extras[]=activities&extras[]=albums&extras[]=license&extras[]=identification&extras[]=qualification&terminal=h5&latitude=${lat}&longitude=${lon}`)
		.then((response)=>{
...
export function getSellerId(id){
	return new Promise((resolve,reject)=>{
		axios.get(`/shopping${URL_API.sellerID}?restaurant_id=${id}`)
		.then((response)=>{
			console.log(response.data)
			let newData = response.data.map(item=>{
				let newItem = {}; 
...
export function getall(id,name,offset,limit) {
	return new Promise((resolve,reject)=>{
		axios.get(`/ugc${URL_API.ratingUrl}${id}/ratings?has_content=true&tag_name=${name}&offset=${offset}&limit=${limit}`)
		.then((response)=>{
			let newData = response.data.map(item=>{
				let newItem = {};
...
export function getRating(id,offset,limit){
	return new Promise((resolve,reject)=>{
		axios.get(`/ugc${URL_API.ratingUrl}${id}/ratings?has_content=true&offset=${offset}&limit=${limit}`)
		.then((response)=>{
			let newData = response.data.map(item=>{
				let newItem = {};
				newItem.username = item.username;
...
export function getselRating(id,offset,limit){
	return new Promise((resolve,reject)=>{
		axios.get(`/ugc${URL_API.selratingUrl}${id}/ratings/scores`)
		.then((response)=>{
...
export function getWell(id) {
	return new Promise((resolve,reject)=>{
		axios.get(`/ugc${URL_API.wellUrl}${id}/rating_categories`)
		.then((response)=>{
...
export function getAllWell(id,offset,limit,record_type) {
	return new Promise((resolve,reject)=>{
		axios.get(`/ugc${URL_API.wellUrl}${id}/ratings?limit=${limit}&offset=${offset}&record_type=${record_type}`)
		.then((response)=>{
